...
export default function ExpenseTracker() {
    ...
    const addTaskHandler = () => {
        ...
        // Empty the value for the price input
        setNewItem("")
        setPrice("")
    }
    ...
    return <>
        ...
        <div className="todo-header dflex flex-wrap justify-content-around m-3 p-3 rounded border border-primary">
        ...
        <div className="tasks">
            ...
            {
                items.map(x => {
                    return <div key={x.id} className="bg-light text-primary border border-primary fs-5 d-flex justify-content-between m-3 p3 rounded">
                        {x.newItem}
